...
const gabungan = [...timA, ...timB, "Zahra"];
console.log("Gabungan : ", gabungan);

const kapten = ["Budi", "Risa"];
const anggota = ["Siti", "Ahmad", "Doni", "Zahra"];
const [kapten1, kapten2] = kapten;
const [anggota1, anggota2, anggota3, anggota4] = anggota;
