...
let t = Date.now(); countingSort([...data], 999); console.log('Counting Sort 0(n)   :', Date.now()-t, 'ms');
t = Date.now(); [...data].sort((a,b)=>a-b); console.log('Array.sort (Timsort) :', Date.now()-t, 'ms');